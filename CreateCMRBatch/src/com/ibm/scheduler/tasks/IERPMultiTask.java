...
public class IERPMultiTask extends BatchTask {
  ...
  public void run() {
    ...
    Process process;
    try {
      process = Runtime.getRuntime().exec("/bin/sh -c /cmr/batch/run_ierp_multi_batch.ksh >> /cmr/batch/batch-run.log 2> /cmr/batch/batch-err.log");
      process.waitFor();
