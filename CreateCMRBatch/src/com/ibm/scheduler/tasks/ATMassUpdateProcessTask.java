...
public class ATMassUpdateProcessTask extends BatchTask {
  String cronExpression = "* 0,6,12,18,24,30,36,42,48,54 * * * *";
  String command = "/bin/sh -c /cmr/batch/run_austria_massUpd_batch.ksh >> /cmr/batch/batch-run.log 2> /cmr/batch/batch-err.log";
