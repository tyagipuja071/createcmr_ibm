...
//  GEOHandler.addAfterConfig(updateIndustryClass, GEOHandler.AP);
  ...
  GEOHandler.addAfterConfig(custSubGrpHandlerINAUSG, [SysLoc.AUSTRALIA]);
  GEOHandler.addAfterTemplateLoad(onIsicChange, [SysLoc.AUSTRALIA]);
  GEOHandler.addAfterConfig(onIsicChange, [SysLoc.AUSTRALIA]);
  GEOHandler.addAfterTemplateLoad(custSubGrpHandlerINAUSG, [SysLoc.AUSTRALIA]);
  ...
  GEOHandler.addAfterConfig(addCustGrpHandler, [SysLoc.AUSTRALIA]);
  ...
  // CREATCMR-7883
  GEOHandler.addAfterTemplateLoad(lockCMRNumberPrefixforNoINTER, [SysLoc.AUSTRALIA], null, true);
