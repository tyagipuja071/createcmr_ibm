...
dojo.addOnLoad(function () {
  ...
  GEOHandler.registerValidator(addSalesRepNameNoCntryValidator, [SysLoc.NEW_ZEALAND]);
  ...
  GEOHandler.enableCustomerNamesOnAddress([SysLoc.NEW_ZEALAND]);

  GEOHandler.registerValidator(addFailedDPLValidator, [SysLoc.NEW_ZEALAND]);
  GEOHandler.registerValidator(addDPLCheckValidator, [SysLoc.NEW_ZEALAND], GEOHandler.ROLE_REQUESTER, true);
  ...
  GEOHandler.registerValidator(addAttachmentValidator, [SysLoc.NEW_ZEALAND], GEOHandler.REQUESTER, false, false);
  GEOHandler.registerValidator(addFormatFieldValidator, [SysLoc.NEW_ZEALAND], null, true);
  GEOHandler.registerValidator(addFieldFormatValidator, [SysLoc.NEW_ZEALAND], null, true);
  GEOHandler.registerValidator(addCtcObsoleteValidator, [SysLoc.NEW_ZEALAND], null, true);
  GEOHandler.registerValidator(checkCmrUpdateBeforeImport, [SysLoc.NEW_ZEALAND], null, true);
