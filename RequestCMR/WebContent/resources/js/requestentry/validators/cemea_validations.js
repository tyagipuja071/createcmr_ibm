...
function lockIBMtab() {
  var role = FormManager.getActualValue('userRole').toUpperCase();
  var custSubType = FormManager.getActualValue('custSubGrp');
  if (role == 'REQUESTER' && 'C' == FormManager.getActualValue('reqType')) {
    // CMR-710
...
//CMR-710 rename the function add AT
...
dojo
    .addOnLoad(function() {
      ...
      GEOHandler.addAfterConfig(reqReasonOnChangeAT, [ SysLoc.AUSTRIA ]);//CMR-710
