...
dojo.addOnLoad(function() {
  ...
  // For Legacy GR, MALTA
  GEOHandler.registerValidator(validateCMRNumberForLegacy, [ SysLoc.GREECE, SysLoc.MALTA ], GEOHandler.ROLE_PROCESSOR, true);
  GEOHandler.registerValidator(validateExistingCMRNo, [ SysLoc.GREECE, SysLoc.MALTA ], GEOHandler.ROLE_PROCESSOR, true);
