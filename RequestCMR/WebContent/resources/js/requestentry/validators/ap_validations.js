...
function addAfterConfigAP() {
  ...
  if (cntry == '834') {
    ...
    // CREATCMR-10202
    if (custSubGrp == 'CROSS' || custSubGrp == 'KYNDR' || custSubGrp == 'ASLOM') {
