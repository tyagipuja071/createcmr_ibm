...
function setIsuOnIsic(){
  ...
  if (_cluster != '') {    
    ...
    else if ((cmrIssuingCntry == '616' || cmrIssuingCntry == '796' ) && (clusterDesc[0] != '' && !(clusterDesc[0].ret1.includes('S1') || clusterDesc[0].ret1.includes('IA') || _cluster.includes('BLAN') || clusterDesc[0].ret1.includes('S&S')))) {
      return;
    }
  }
...
dojo.addOnLoad(function() {
  ...
  GEOHandler.registerValidator(addAttachmentValidator, [SysLoc.SRI_LANKA, SysLoc.BANGLADESH, SysLoc.NEPAL,SysLoc.SINGAPORE,SysLoc.AUSTRALIA], GEOHandler.REQUESTER, false, false);
