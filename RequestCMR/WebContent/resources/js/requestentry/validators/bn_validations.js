...
// if (landCntry == '' ||
// FormManager.GETFIELD_VALIDATIONS['landCntry'].indexOf(Validators.REQUIRED) <
// 0)
...
function setKUKLAvaluesBD() {
  ...
  var custSubGrp1 = new Set(['ASLOM', 'DUMMY', 'XASLM']);
  ...
  if (reqType == 'C') {
    ...
    if (results != null) {
      if (custSubGrp1.has(custSubGrp)) {
        ...
        FormManager.setValue('custClass', kuklaBD[3]);
...
dojo.addOnLoad(function() {
  ...
  // CREATCMR-10575
  GEOHandler.addAfterConfig(setDropdownField2Values, GEOHandler.AP);
...
// null, true);
  ...
  GEOHandler.addAfterTemplateLoad(clearClusterFieldsOnScenarioChange, [SysLoc.AUSTRALIA, SysLoc.NEW_ZEALAND, SysLoc.PHILIPPINES, SysLoc.VIETNAM, SysLoc.THAILAND,SysLoc.SINGAPORE] );  
  // CREATCMR-7883
