...
function setAbbreviatedNameBasedOnAddressType() {
	...
	if (reqType == 'C') {
		...
		var custNm1Result = cmr.query('ADDR.GET.CUSTNM1.BY_REQID_ADDRTYP',
				custNm1Params);
		...
		var custNm1Result2 = cmr.query('ADDR.GET.CUSTNM1.BY_REQID_ADDRTYP',
				custNm1Params2);
		var custNm2 = custNm1Result2.ret1;
	}

	if (custNm1 != undefined && custNm1 != '' && (subCustGrp == '3PA' || subCustGrp == 'X3PA')) {
		FormManager.setValue('abbrevNm', "C/O " + custNm1.substring(0, 20)
				+ " 3PA");
