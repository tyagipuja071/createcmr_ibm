...
function continueCRISSearch() {
  ...
  var chosenScenario = FormManager.getActualValue('custSubGrp');
  console.log('custSubGrp: ' + chosenScenario);
  _criswindow = WindowMgr.open('CRIS', 'CRIS', 'rdcsearch?clear=Y&scenario=' + chosenScenario, 1200, 550);
