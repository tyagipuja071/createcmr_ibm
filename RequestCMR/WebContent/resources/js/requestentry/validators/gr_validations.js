...
function setClientTierForCreates(isuCd, clientTier) {
  var reqType = null;
...
function setISRValuesGR() {
  ...
  FormManager.readOnly('subIndustryCd');
  if (custSubGrp == 'COMME' || custSubGrp == 'CROSS' || custSubGrp == 'PRICU' || custSubGrp == 'GOVRN' || custSubGrp == '' || custSubGrp == 'BUSPR'
...
dojo.addOnLoad(function() {
  ...
  GEOHandler.registerValidator(clientTierCodeValidator, [ SysLoc.GREECE ], null, true);
