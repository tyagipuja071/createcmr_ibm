  ...
  FormManager.addFormValidator((function() {
    return {
      validate : function() {
        ...
        if (reqType == 'C') {
          if (soldToDistrict != null && districts.includes(soldToDistrict.toUpperCase())) {
            vatPattern = /[0-9]{9}/;
            ...
            if (vat.match(/[0-9]{10}/) || vat.match(/[0-9]{11}/)) {
              ...
              return new ValidationResult({
                ...
                type : 'text',
                name : 'vat'
              }, false, 'Format for VAT is incorrect. Correct format is 9999999999 or 99999999999.');
            }
          }
        }
