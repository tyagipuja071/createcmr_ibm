...
function commentImgFormatter(value, rowIndex) {
  ...
  if (value.indexOf('@') > 0) {
    if (value.indexOf('ibm.com') > 0) {
      return '<img title="' + value + '" src="https://w3-ui-unified-profile-proxy.w3-ui.dal.app.cirrus.ibm.com/up-api-proxy/v3/image/' + value + '" class="cmt-img" onerror="this.onerror=null; this.src=\''
