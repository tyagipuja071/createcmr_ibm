...
function showAccount(accountNo, establishmentNo, companyNo){
  window.location = '<%=request.getContextPath()+"/window/rdcaccountdet/"%>'+accountNo+'?companyNo='+companyNo+'&establishmentNo='+establishmentNo+'&fromAccount=Y&&access=<%=access%>';
}
...
<cmr:window>
  ...
  <cmr:form method="POST" action="<%=actionUrl%>" name="frmCMR" class="ibm-column-form ibm-styled-form" modelAttribute="crit">
    ...
    <cmr:row>
      <cmr:column span="6">
        <cmr:grid url="/rdcaccountlistget.json" id="accountlistgrid" span="6" width="1100" height="400" useFilter="true">
