...
<cmr:boxContent>
  ...
  <cmr:section>
    ...
    <cmr:row topPad="20">
      <cmr:column span="6">
        Your rejection has been processed. A notification has been sent to the requester <b><%=approval.getRequester()%></b>.
      </cmr:column>
    </cmr:row>
    <cmr:row topPad="10">
      <cmr:column span="6">
...
<cmr:boxContent>
  ...
  <cmr:section>
    <cmr:row>
      <cmr:column span="6">
        <h3>Please provide the reason for rejection and your comments</h3>
      </cmr:column>
    </cmr:row>
    <cmr:row topPad="20">
      <cmr:column span="3">
    ...
    <cmr:row topPad="10">
      <cmr:column span="3">
            <form:select dojoType="dijit.form.FilteringSelect" id="rejReason" searchAttr="name" style="display: block;" maxHeight="200" required="false" path="rejReason" placeHolder="Select Reason">
            </form:select>
      </cmr:column>
    </cmr:row>
    <cmr:row topPad="20">
    ...
    <cmr:row topPad="10">
      <cmr:column span="4">
        <form:textarea path="comments" id="comments" rows="5" cols="60"></form:textarea>
      </cmr:column>
      <cmr:column span="2" >
        <p>
