...
<cmr:boxContent>
  ...
  <cmr:section>
    ...
    <cmr:row topPad="20">
      <cmr:column span="6">
        Your approval has been processed. A notification has been sent to the requester <b><%=approval.getRequester()%></b>.
      </cmr:column>
    </cmr:row>
    <cmr:row topPad="10">
      <cmr:column span="6">
...
<cmr:boxContent>
  ...
  <cmr:section>
    <cmr:row>
      <cmr:column span="6">
        <h3>Please provide your comments for the approval</h3>
      </cmr:column>
    </cmr:row>
    <cmr:row topPad="20">
      <cmr:column span="3">
