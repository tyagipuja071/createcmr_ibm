  ...
  <cmr:form method="POST" action="${contextPath}/code/jpofficesectorinacform" id="frmCMR" name="frmCMR" class="ibm-column-form ibm-styled-form" modelAttribute="jpofficesectorinacform" >
    ...
    <cmr:section>
	 ...
	 <cmr:row>
        ...
        <cmr:column span="2">
            <form:input id="officeCd" path="officeCd" dojoType="dijit.form.TextBox" placeHolder="OFFICE_CD"  maxlength="15"/>
        </cmr:column>
      </cmr:row>
      ...
      <cmr:row>
        ...
        <cmr:column span="2">
            <form:input id="sectorCd" path="sectorCd" dojoType="dijit.form.TextBox" placeHolder="SECTOR_CD"  maxlength="15"/>
        </cmr:column>
      </cmr:row>
      ...
      <cmr:row>
        ...
        <cmr:column span="2">
            <form:input id="inacCd" path="inacCd" dojoType="dijit.form.TextBox" placeHolder="INAC_CD"  maxlength="15"/>
        </cmr:column>
      </cmr:row>
      ...
      <cmr:row>
        ...
        <cmr:column span="2">
          <form:input id="apCustClusterId" path="apCustClusterId" dojoType="dijit.form.TextBox" placeHolder="AP_CUST_CLUSTER_ID"  />
        </cmr:column>
      </cmr:row>
      ...
      <cmr:row>
        ...
        <cmr:column span="2">
<%--           <c:if test="${jpofficesectorinacform.createTs != null}"> --%>
<%--             ${jpofficesectorinacform.createTs} --%>
<%--           </c:if> --%>
<%--           <c:if test="${jpofficesectorinacform.createTs == null}">-</c:if> --%>
<%--           <form:hidden id="createDt" path="createDt" /> --%>
      ...
      <cmr:row>
        ...
        <cmr:column span="2">
<%--           <c:if test="${jpofficesectorinacform.updateTs != null}"> --%>
<%--             ${jpofficesectorinacform.updateTs} --%>
<%--           </c:if> --%>
<%--           <c:if test="${jpofficesectorinacform.updateTs == null}">-</c:if> --%>
