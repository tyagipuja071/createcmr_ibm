  ...
  var actions = (function() {
    return {
      ...
      refresh : function(){
        ...
        CmrGrid.refresh('usibmboGrid', url, 'iOff=:iOff');
      }
    };
  })();
</script>
...
<form:form method="POST" action="#" name="frmCMR" class="ibm-column-form ibm-styled-form"
  modelAttribute="us_ibm_bo" id="frmCMR">
  <cmr:boxContent>
    <cmr:tabs />
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="2">
          <cmr:label fieldId="aLevel1Value">I_OFF: 
            <cmr:info text="Enter I OFF of code."></cmr:info>
          </cmr:label>
          <input id="iOff" name="iOff" dojoType="dijit.form.TextBox" />
        </cmr:column>
  ...
  <cmr:boxContent>
    ...
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="6">
          <h3>US IBM BO List</h3>
        </cmr:column>
      </cmr:row>
      
      <cmr:row topPad="10" addBackground="false">
        <cmr:column span="6">
          <cmr:grid url="/code/us_ibm_bo_list.json" id="usibmboGrid" span="6" height="400" usePaging="true">
            <cmr:gridCol width="80px" field="iOff" header="I_OFF">
              <cmr:formatter>
                function(value){
...
<cmr:section alwaysShown="true">
  <cmr:buttonsRow>
    <cmr:button label="Add US IBM BO" onClick="actions.add()" highlight="true" />
