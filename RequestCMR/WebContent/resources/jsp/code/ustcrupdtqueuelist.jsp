...
<script>
  ...
  var actions = (function() {
    return {
      update : function(tcrFileNm, seqNo) {
        window.location = cmr.CONTEXT_ROOT + '/code/us_tcr_updt_queue_form?mandt=' + mandt + '&tcrFileNm=' + encodeURIComponent(tcrFileNm) + '&seqNo=' + encodeURIComponent(seqNo);
      },
      ...
      refresh : function(){
        var url = cmr.CONTEXT_ROOT + '/code/us_tcr_updt_queue_list.json';
        CmrGrid.refresh('usTcrUpdtQueueGrid', url, 'tcrFileNm=:tcrFileNm');
      }
    };
  })();
</script>
...
<cmr:form method="POST" action="#" name="frmCMR" class="ibm-column-form ibm-styled-form" modelAttribute="us_tcr_updt_queue" id="frmCMR">
  <cmr:boxContent>
    ...
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="2">
          <cmr:label fieldId="tcrInputFileNm">TCR_INPUT_FILE_NM: 
            <cmr:info text="Enter TCR_INPUT_FILE_NM of code."></cmr:info>
          </cmr:label>
          <input id="tcrFileNm" name="tcrFileNm" dojoType="dijit.form.TextBox" />
        </cmr:column>
  ...
  <cmr:boxContent>
    ...
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="6">
          <h3>US TCR UPDT QUEUE List</h3>
        </cmr:column>
      </cmr:row>
      
      <cmr:row topPad="10" addBackground="false">
        <cmr:column span="6">
          <cmr:grid url="/code/us_tcr_updt_queue_list.json" id="usTcrUpdtQueueGrid" span="6" height="400" usePaging="true">
            <cmr:gridCol width="180px" field="tcrFileNm" header="TCR_INPUT_FILE_NM" />
            <cmr:gridCol width="60px" field="seqNo" header="SEQ_NO" />
            <cmr:gridCol width="150px" field="lineContent" header="LINE_CONTENT" />
            <cmr:gridCol width="60px" field="cmrNo" header="CMR_NO" />
            <cmr:gridCol width="90px" field="procStatus" header="PROC_STATUS">
              <cmr:formatter>
                function(value) {
                  if (value == 'E'){
            ...
            <cmr:gridCol width="300px" field="procMsg" header="PROC_MSG" />
