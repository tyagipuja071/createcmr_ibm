...
<script>
  ...
  var actions = (function() {
    return {
      add : function() {
        window.location = cmr.CONTEXT_ROOT + '/code/us_company_form';
      },
      update : function(compNo) {
        window.location = cmr.CONTEXT_ROOT + '/code/us_company_form?mandt=' + mandt + '&compNo=' + encodeURIComponent(compNo);
      },
      actionIcons : function(value, rowIndex) {
        ...
        var actionsTag = '';
        actionsTag += '<img src="' + imgloc + 'addr-edit-icon.png" class="addr-icon" title="Update" onclick="actions.update(\'' + rowData.compNo + '\')" />';
               
        return actionsTag;
      },
      refresh : function(){
        var url = cmr.CONTEXT_ROOT + '/code/us_company_list.json';
        CmrGrid.refresh('uscompanyGrid', url, 'compNo=:compNo');
      }
    };
  })();
</script>
...
<cmr:form method="POST" action="#" name="frmCMR" class="ibm-column-form ibm-styled-form"
  modelAttribute="us_company" id="frmCMR">
  <cmr:boxContent>
    <cmr:tabs />
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="2">
          <cmr:label fieldId="compNo">Company: 
            <cmr:info text="Enter Company Number."></cmr:info>
          </cmr:label>
          <input id="compNo" name="compNo" dojoType="dijit.form.TextBox" />
        </cmr:column>
  ...
  <cmr:boxContent>
    ...
    <cmr:section>
      ...
      <cmr:row topPad="8">
        <cmr:column span="6">
          <h3>US Company List</h3>
        </cmr:column>
      </cmr:row>
      
      <cmr:row topPad="10" addBackground="false">
        <cmr:column span="6">
          <cmr:grid url="/code/us_company_list.json" id="uscompanyGrid" span="6" height="400" usePaging="true">
            <cmr:gridCol width="80px" field="compNo" header="Comapny No.">
              <cmr:formatter>
                function(value){
            ...
            <cmr:gridCol width="120px" field="entNo" header="Enterprise No." />
            <cmr:gridCol width="120px" field="compLegalName" header="Company Name" />
...
<cmr:section alwaysShown="true">
  <cmr:buttonsRow>
    <cmr:button label="Add US Company" onClick="actions.add()" highlight="true" />
