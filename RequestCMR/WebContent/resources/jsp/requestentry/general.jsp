 	...
 	<% autoProcCapable = true ;%>
        ...
        <div class="ibm-col-6-2">
            ...
            <table border="2" cellspacing="0" cellpadding="0" class="cmr-scorecard">
              ...
              <%}%>
              <cmr:view forCountry="358,359,363,607,620,626,651,675,677,680,694,695,713,741,752,762,767,768,772,787,805,808,821,823,832,842,849,850,865,889,641,766,858,755,871">
              <tr>
                <td>Proliferation Checklist
                    <%if (!readOnly){%>
