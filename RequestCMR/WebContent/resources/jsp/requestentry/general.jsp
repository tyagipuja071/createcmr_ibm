 	...
 	<% autoProcCapable = true ;%>
        ...
        <cmr:column span="2" width="310">
            ...
            <table border="2" cellspacing="0" cellpadding="0" class="cmr-scorecard">
              ...
              <%}%>
              <cmr:view forCountry="358,359,363,603,607,620,626,651,675,677,680,694,695,699,705,707,713,741,752,762,767,768,772,787,805,808,821,823,832,849,850,865,889,641">
              <tr>
                <td>Proliferation Checklist
                    <%if (!readOnly){%>
                      <span class="ibm-required cmr-required-spacer">*</span>
