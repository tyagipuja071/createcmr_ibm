...
<cmr:view forGEO="EMEA">
  ...
  <cmr:row addBackground="false">
    <cmr:column span="2" containerForField="SpecialTaxCd" exceptForCountry="666,726,862">
      <p>
    ...
    <cmr:column span="2" width="170">
     <p>
        ...
        <cmr:buttonsRow>
        <cmr:button id="validateFiscalData" label="${ui.btn.validateFiscalData}" onClick="doValidateFiscalDataModal()" highlight="true" />
        </cmr:buttonsRow>
         </p>
    </cmr:column>
    <%} %>
  ...
  <cmr:view forCountry="758">
    <cmr:row addBackground="true">
      <cmr:column span="2" containerForField="IdentClient">
        <p>
          ...
          <cmr:field path="identClient" id="identClient" fieldId="IdentClient" tabId="MAIN_CUST_TAB" />
        </p>
      </cmr:column>
      ...
      <cmr:column span="2" containerForField="CrosSubTyp">
        <p>
          ...
          <cmr:field path="crosSubTyp" id="crosSubTyp" fieldId="CrosSubTyp" tabId="MAIN_CUST_TAB" />
        </p>
      </cmr:column>
	...
	<cmr:column span="2" containerForField="TipoCliente">
        <p>
          <cmr:label fieldId="icmsInd">
            <cmr:fieldLabel fieldId="TipoCliente" />:
                <cmr:delta text="${rdcdata.icmsInd}" oldValue="${reqentry.icmsInd}" />
          </cmr:label>
          <cmr:field id="icmsInd" path="icmsInd" fieldId="TipoCliente" tabId="MAIN_CUST_TAB"  />
        </p>
      </cmr:column>
		...
		<p>
			<cmr:label fieldId="hwSvcsRepTeamNo">
				...
				<cmr:delta text="${rdcdata.hwSvcsRepTeamNo}" oldValue="${reqentry.hwSvcsRepTeamNo}" />
			</cmr:label>
			<cmr:field path="hwSvcsRepTeamNo" id="hwSvcsRepTeamNo" fieldId="CodiceDestinatarioUfficio" tabId="MAIN_CUST_TAB" />
		</p>
	</cmr:column>
	<cmr:column span="2" containerForField="PEC">
		<p>
			...
			<cmr:field path="email2" id="email2" fieldId="PEC" tabId="MAIN_CUST_TAB" />
		</p>
	</cmr:column>
    </cmr:row>
    <cmr:row>
    ...
    <cmr:field path="email3" id="email3" fieldId="IndirizzoEmail" tabId="MAIN_CUST_TAB" />
    </p>
    </cmr:column>
    </cmr:row>
