        ...
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
          <%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
            ...
            <%@ taglib uri="/tags/cmr" prefix="cmr" %>
              <% RequestEntryModel reqentry=(RequestEntryModel) request.getAttribute("reqentry"); Boolean
                readOnly=(Boolean) request.getAttribute("yourActionsViewOnly"); if (readOnly==null){ readOnly=false; }
                ...
                <cmr:section id="IBM_REQ_TAB" hidden="true">
                    ...
                    <cmr:column span="1" containerForField="CMRNumber">
                      <p>
                        <cmr:label fieldId="cmrNo">
                          ...
                          <span id="cmrDelta">
                            <cmr:delta text="${rdcdata.cmrNo}" oldValue="${reqentry.cmrNo}" />
                          </span>
                        </cmr:label>
                        <cmr:field fieldId="CMRNumber" size="18" id="cmrNo" path="cmrNo" tabId="MAIN_IBM_TAB"
                          size="150" />
                      </p>
                    </cmr:column>
                    <cmr:view>
                      ...
                      <cmr:column span="1" containerForField="Military">
                        <p>
                          ...
                          <cmr:label fieldId="military" forRadioOrCheckbox="true">
                            ...
                            <cmr:info
                              text="Military Use means that the company is owned, managed, or intended to be used by the local government's Military. This is for Export Regulations.">
                            </cmr:info>
                            <cmr:delta text="${rdcdata.military}"
                              oldValue="${reqentry.military == 'Y' ? 'Yes' : 'No'}" />
                          </cmr:label>
                        </p>
                      </cmr:column>
                    </cmr:view>
                  ...
                  <!-- Site Party ID -->
                  <cmr:row topPad="10" addBackground="true">
                    <cmr:column span="2" containerForField="SitePartyID" forGEO="IERP,MCO2,EMEA,JP,NORDX,NL,BELUX"
                      forCountry="846,806,702,678,624,788">
                      <p>
                  ...
                  <cmr:row topPad="10">
                    ...
                    <cmr:column span="1" width="120" containerForField="INACType"
                      exceptForCountry="666,726,862,822,838,618,758,848"
                      exceptForGEO="MCO1,MCO2,FR,CEMEA,NORDX,BELUX,NL">
                      <p>
                    ...
                    <cmr:column span="1" width="140" containerForField="INACCode">
                      <p>
                        ...
                        <cmr:view forCountry="760">
                          <%if (!readOnly){%>
                            <span class="cmr-bluepages-ro" title="INACCode Search"
                              style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:12px;"
                              id="geoLocDescCont"><a
                                href="https://w3-connections.ibm.com/communities/service/html/communityview?communityUuid=aba599bd-cf1d-4beb-9e20-7a2b9adbed22#fullpageWidgetId=W0564147ab889_45f2_aeba_df5811201a32&file=bba58209-19fe-4d81-9d1d-cc074d89d6e5"
                                target="_blank">INAC/NAC Code Search</a></span>
                            <%}%>
                        </cmr:view>
                      </p>
                    ...
                    <cmr:row topPad="10">
                      ...
                      <cmr:column span="2" containerForField="ClientTier2">
                        <p>
                          ...
                          <cmr:field fieldId="ClientTier2" id="dupClientTierCd" path="dupClientTierCd"
                            tabId="MAIN_IBM_TAB" />
                        </p>
                      </cmr:column>
                    </cmr:row>
                  ...
                  <cmr:view exceptForCountry="643,749,778,818,834,852,856,646,714,720,848,649"
                    exceptForGEO="FR,JP,MCO2">
                    <cmr:row topPad="10" addBackground="true">
                      <cmr:column span="2" containerForField="Enterprise" exceptForGEO="MCO1,NORDX"
                        exceptForCountry="755">
                        <p>
                          ...
                          <%-- <cmr:view forCountry="618">
                            <% if (reqentry.getReqType().equalsIgnoreCase("C")) { String findCmrJs="onclick=\"
                              importByEnterprise()\""; if (readOnly){ findCmrJs="" ; } %>
                  ...
                  <cmr:column span="2" containerForField="Company" exceptForCountry="666,726,862,822,838,724"
                  ...
                  <cmr:column span="2" containerForField="Affiliate" exceptForCountry="666,726,862,822,838,641"
                    ...
                    <cmr:row topPad="10" addBackground="true">
                      <cmr:column span="2" containerForField="Enterprise2">
                        <p>
                          ...
                          <cmr:field fieldId="Enterprise2" id="dupEnterpriseNo" path="dupEnterpriseNo"
                            tabId="MAIN_IBM_TAB" />
                        </p>
                      </cmr:column>
                    </cmr:row>
                  ...
                  <cmr:row topPad="10">
                    <cmr:column span="2" containerForField="BuyingGroupID">
                      <p>
                        ...
                        <span class="cmr-bluepages-ro" id="bgDescCont">${reqentry.bgDesc != null ? reqentry.bgDesc :
                    ...
                    <cmr:column span="2" containerForField="GlobalBuyingGroupID">
                      <p>
                        ...
                        <span class="cmr-bluepages-ro" id="gbgDescCont">${reqentry.gbgDesc != null ? reqentry.gbgDesc :
                          "(no description available)"}</span>
                      </p>
                    </cmr:column>
                  ...
                  <cmr:row topPad="10">
                    <cmr:column span="2" containerForField="CoverageID">
                      <p>
                        ...
                        <span class="cmr-bluepages-ro" id="covDescCont">${reqentry.covDesc != null ? reqentry.covDesc :
                          "(no description available)"}</span>
                      </p>
                    </cmr:column>
                    <cmr:view exceptForGEO="JP">
                      <cmr:column span="2" containerForField="GeoLocationCode">
                        <p>
                          ...
                          <cmr:field fieldId="GeoLocationCode" id="geoLocationCd" path="geoLocationCd"
                            tabId="MAIN_IBM_TAB" />
                          <form:hidden path="geoLocDesc" id="geoLocDesc" />
                          <span class="cmr-bluepages-ro" id="geoLocDescCont">${reqentry.geoLocDesc != null ?
                      ...
                      <p>
                        ...
                        <%if (!readOnly){%>
                          <span class="cmr-bluepages-ro" title="Validate DUNS against D&B"
                            style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:12px;"
                            id="geoLocDescCont"><a href="javascript: checkDUNSWithDnB()">Open D&B Details</a></span>
                          <%}%>
                      </p>
                    </cmr:column>
                  </cmr:row>
                    ...
                    <%}%>
                      ...
                      <cmr:view exceptForCountry="643,749,778,818,834,852,856,646,714,720,760,649">
                        <cmr:row topPad="10" addBackground="true">
                          ...
                          <cmr:column exceptForGEO="MCO2" span="2" containerForField="MembLevel"
                            exceptForCountry="754,866,822,666,644,668,693,704,708,740,820,821,826,358,359,363,603,607,626,651,694,695,699,705,707,787,741,889,838,620,642,675,677,680,752,762,767,768,772,805,808,823,832,849,850,865,729,780,706,624,788">
                            <p>
                          ...
                          <cmr:column exceptForGEO="MCO2" span="2" containerForField="BPRelationType"
                            exceptForCountry="754,866,822,666,644,668,693,704,708,740,820,821,826,358,359,363,603,607,626,651,694,695,699,705,707,787,741,889,838,620,642,675,677,680,752,762,767,768,772,805,808,823,832,849,850,865,729,780,706,624,788">
                            <p>
                        ...
                        <%-- CMR-3869 <cmr:view exceptForGEO="MCO2,CN"
                          exceptForCountry="644,668,693,704,708,740,820,821,826,358,359,363,603,607,626,651,694,695,699,705,707,787,741,889,838,620,642,675,677,680,752,762,767,768,772,805,808,823,832,849,850,865,729,618,624,788,862,754,866">
                          <cmr:row topPad="10" addBackground="true">
