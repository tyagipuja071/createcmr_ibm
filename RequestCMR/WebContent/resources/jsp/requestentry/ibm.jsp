...
<%--           <cmr:view forCountry="618">
  ...
  <%}%>
   ...
   <cmr:view exceptForCountry="643,749,778,818,834,852,856,646,714,720,760">
        ...
        <cmr:column span="2" containerForField="MembLevel" exceptForCountry="754,866,822,666,644,668,693,704,708,740,820,821,826,358,359,363,603,607,626,651,694,695,699,705,707,787,741,889">
          <p>
        ...
        <cmr:column span="2" containerForField="BPRelationType" exceptForCountry="754,866,822,666,644,668,693,704,708,740,820,821,826,358,359,363,603,607,626,651,694,695,699,705,707,787,741,889">
          <p>
