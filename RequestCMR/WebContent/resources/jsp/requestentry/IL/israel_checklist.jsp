...
<cmr:checklist title1="CMR Military and Proliferation Screening Checklist" title2="CUSTOMER ELIGIBILITY CHECKLIST">
  ...
  <cmr:chk-section name="Section A">
    ...
    <cmr:chk-entry number="6" section="A">
      There is an indication that the products/services are destined for a <span style="font-weight: bold;">sanctioned country/region: (Cuba, Iran, North Korea, Syria and the Crimea region of Ukraine)</span>.
      <br>
