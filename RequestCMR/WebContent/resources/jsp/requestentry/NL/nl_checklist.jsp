...
%>
 ...
 <cmr:checklist title1="MULTIPURPOSE PROLIFERATION AND MILITARY SCREENING CHECKLIST FOR IBM CLOUD/SOFTLAYER OFFSHORE MODEL"> 
   <cmr:chk-block>Applicable to the following countries:<br>
    Abu Dhabi, Afghanistan, Armenia, Azerbaijan, Bahrain, Belarus, Cambodia, China, Cuba, Egypt, Georgia, Hong Kong, Iran,  
    Iraq, Israel, Jordan, Kazakhstan, Korea-Democratic People's Rep, Kuwait, Kyrgyzstan, Laos, Lebanon, Libya, Macau, Moldova, 
   ...
   <cmr:chk-block>THESE NEXT SET OF QUESTIONS ONLY APPLY IF THE LANDING COUNTRY IS : CHINA, HONG KONG, AND/OR MACAU</cmr:chk-block>
