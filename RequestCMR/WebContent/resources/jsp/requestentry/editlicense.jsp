							...
							<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
								...
								<%@ taglib uri="/tags/cmr" prefix="cmr" %>
									<% RequestEntryModel reqentry=(RequestEntryModel) request.getAttribute("reqentry");
										...
										<cmr:modal title="License Entry:" id="addUpdateLicenseModal" widthId="700">
											<cmr:form method="GET" action="${contextPath}/request/license/process"
												name="addUpdateLicenseModal" class="ibm-column-form ibm-styled-form"
												...
												<cmr:row>
													<cmr:column span="1" containerForField="LicenseNumber" width="150">
														<p>
															...
															<cmr:field fieldId="LicenseNumber" id="licenseNum"
																path="licenseNum" size='130' />
														</p>
													</cmr:column>
													...
													<input type="hidden" id="oldLicenseNumber"
