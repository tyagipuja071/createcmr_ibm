						...
						<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
							...
							<%@ taglib uri="/tags/cmr" prefix="cmr" %>
								<% RequestEntryModel reqentry=(RequestEntryModel) request.getAttribute("reqentry");
									Boolean readOnly=(Boolean) request.getAttribute("yourActionsViewOnly"); if
									(readOnly==null){ readOnly=false; } boolean
									newEntry=BaseModel.STATE_NEW==reqentry.getState(); %>
									...
									<cmr:section id="IBM_REQ_TAB" hidden="true">
											...
											<cmr:column span="1" containerForField="CMRNumber">
												<p>
													<cmr:label fieldId="cmrNo">
														...
														<span id="cmrDelta">
															<cmr:delta text="${rdcdata.cmrNo}"
																oldValue="${reqentry.cmrNo}" />
														</span>
													</cmr:label>
													<cmr:field fieldId="CMRNumber" size="18" id="cmrNo" path="cmrNo"
														tabId="MAIN_IBM_TAB" size="150" />
												</p>
											</cmr:column>
											<cmr:column span="1" containerForField="CAP">
												<p>
													...
													<cmr:label fieldId="capInd" forRadioOrCheckbox="true">
														...
														<cmr:delta text="${rdcdata.capInd}"
															oldValue="${reqentry.capInd == 'Y' ? 'Yes' : 'No'}" />
													</cmr:label>
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="CMROwner">
												<p>
													<cmr:label fieldId="cmrOwner">
														...
														<cmr:delta text="${rdcdata.cmrOwner}"
															oldValue="${reqentry.cmrOwner}" />
													</cmr:label>
													<cmr:field fieldId="CMROwner" id="cmrOwner" path="cmrOwner"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
										</cmr:row>
												...
												<p>
													<cmr:label fieldId="apCustClusterId">
														...
														<%-- <cmr:view forCountry="744">
															...
															<cmr:delta text="${rdcdata.apCustClusterId}"
																oldValue="${reqentry.apCustClusterId}" />
															<cmr:view forCountry="615,652">
																<cmr:info text="${ui.info.AUForCluster}" />
															</cmr:view>
													</cmr:label>
													<cmr:field path="apCustClusterId" id="apCustClusterId"
														fieldId="Cluster" tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="ClientTier">
												<p>
													<cmr:label fieldId="clientTier">
														...
														<cmr:delta text="${rdcdata.clientTier}"
															oldValue="${reqentry.clientTier}" code="L" />
													</cmr:label>
													<cmr:field fieldId="ClientTier" id="clientTier" path="clientTier"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="ISU">
												<p>
													<cmr:label fieldId="isuCd">
														...
														<cmr:delta text="${rdcdata.isuCd}" oldValue="${reqentry.isuCd}"
															code="L" />
													</cmr:label>
										...
										<cmr:row topPad="10">
											...
											<cmr:column span="2" containerForField="BPRelationType"
												exceptForCountry="643,749,778,818,834,852,856,646,714,720">
												<p>
													<cmr:label fieldId="bpRelType">
														<cmr:fieldLabel fieldId="BPRelationType" />:
														<cmr:delta text="${rdcdata.bpRelType}"
															oldValue="${reqentry.bpRelType}" code="L" />
													</cmr:label>
													<cmr:field fieldId="BPRelationType" id="bpRelType" path="bpRelType"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="BPName" forCountry="738,736">
												<p>
													<label for="bpName">
														...
														<cmr:delta text="${rdcdata.bpName}"
															oldValue="${reqentry.bpName}" code="L" />
													</label>
													<cmr:field path="bpName" id="bpName" fieldId="BPName"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="ProvinceName"
												exceptForCountry="738,736">
												<p>
													<cmr:label fieldId="busnType">
														<cmr:fieldLabel fieldId="ProvinceName" />:
													</cmr:label>
													<cmr:field path="busnType" id="busnType" fieldId="ProvinceName"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="ProvinceCode"
												...
												<p>
													...
													<cmr:field path="territoryCd" id="territoryCd"
														fieldId="ProvinceCode" tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="CustomerServiceCd" forCountry="796">
												<p>
													<cmr:label fieldId="engineeringBo">
														<cmr:fieldLabel fieldId="CustomerServiceCd" />:
													</cmr:label>
													<cmr:field path="engineeringBo" id="engineeringBo"
														fieldId="CustomerServiceCd" tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
										</cmr:row>
										...
										<cmr:row topPad="10">
											<cmr:column span="2" containerForField="SalRepNameNo">
												<p>
													<cmr:label fieldId="repTeamMemberNo">
														<cmr:fieldLabel fieldId="SalRepNameNo" />:<cmr:info
															text="No impact on CMR/account owner, just AP CMR legacy system(WTAAS) requirement. ">
														</cmr:info>
														<cmr:delta text="${rdcdata.repTeamMemberNo}"
															oldValue="${reqentry.repTeamMemberNo}" />
														<cmr:view exceptForCountry="736,738">
															<div class="cmr-inline">
																<cmr:bluepages model="salesRepNameNo"
																	namePath="repTeamMemberName"
																	idPath="repTeamMemberNo" useUID="true"
																	editableId="true" />
											...
											<cmr:column span="2" containerForField="CmrNoPrefix">
												<p>
													...
													<cmr:field path="cmrNoPrefix" id="cmrNoPrefix" fieldId="CmrNoPrefix"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
												...
												<p>
													<cmr:label fieldId="collectionCd">
														...
														<cmr:delta text="${rdcdata.collectionCd}"
															oldValue="${reqentry.collectionCd}"
															id="delta-engineeringBo" />
													</cmr:label>
										...
										<cmr:row topPad="10" addBackground="true">
												...
												<cmr:column span="1" width="100" containerForField="INACType">
													<p>
														<cmr:label fieldId="inacType">
															...
															<cmr:delta text="${rdcdata.inacType}"
																oldValue="${reqentry.inacType}" code="L" />
														</cmr:label>
														<cmr:field id="inacType" path="inacType" fieldId="INACType"
															tabId="MAIN_IBM_TAB" size="80" />
													</p>
												</cmr:column>
												<cmr:column span="1" width="230" containerForField="INACCode">
													<p>
														<cmr:label fieldId="inacCd">
															...
															<cmr:delta text="${rdcdata.inacCd}"
																oldValue="${reqentry.inacCd}" />
														</cmr:label>
														<cmr:field size="180" fieldId="INACCode" id="inacCd"
															path="inacCd" tabId="MAIN_IBM_TAB" />
													</p>
												</cmr:column>
											</cmr:view>
											<cmr:view forCountry="736,738">
												...
												<cmr:column span="1" width="140" containerForField="INACCode">
													<p>
														...
														<cmr:field size="80" fieldId="INACCode" id="inacCd"
															path="inacCd" tabId="MAIN_IBM_TAB" />
													</p>
												</cmr:column>
											</cmr:view>
											<cmr:column span="2" containerForField="ISBU">
												<p>
													<cmr:label fieldId="isbuCd">
														<cmr:fieldLabel fieldId="ISBU" />:
													</cmr:label>
													<cmr:field path="isbuCd" id="isbuCd" fieldId="ISBU"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="IndustryClass">
												<p>
													<Label style="">IndustryClass:</Label> <input type="text"
														id="IndustryClass" name="IndustryClass"
														value="${fn:substring(reqentry.subIndustryCd, 0, 1)}"
														readonly="readonly"
														style="width: 15px; BACKGROUND: #FFFFEE; border: 1px Solid #DDDDDD" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="RestrictedInd">
												<p>
													<cmr:label fieldId="restrictInd">
														<cmr:fieldLabel fieldId="RestrictedInd" />:
													</cmr:label>
													<cmr:field path="restrictInd" id="restrictInd"
														fieldId="RestrictedInd" tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
										</cmr:row>
										...
										<cmr:row topPad="10" addBackground="true">
											<cmr:column span="2" containerForField="RegionCode">
												<p>
													<cmr:label fieldId="miscBillCd">
														<cmr:fieldLabel fieldId="RegionCode" />:
													</cmr:label>
													<cmr:field path="miscBillCd" id="miscBillCd" fieldId="RegionCode"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="GovIndicator">
												<p>
													<cmr:label fieldId="govType">
														<cmr:fieldLabel fieldId="GovIndicator" />:
													</cmr:label>
													<cmr:field path="govType" id="govType" fieldId="GovIndicator"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
												...
												<cmr:column span="2" containerForField="LocalTax2">
													<p>
														<label for="taxCd2">
															...
															<cmr:delta text="${rdcdata.taxCd2}"
																oldValue="${reqentry.taxCd2}" />
														</label>
														<cmr:field path="taxCd2" id="taxCd2" fieldId="LocalTax2"
															tabId="MAIN_CUST_TAB" />
													</p>
												</cmr:column>
											</cmr:view>
											<cmr:column span="2" containerForField="Sector">
												<p>
													<cmr:label fieldId="sectorCd">
														<cmr:fieldLabel fieldId="Sector" />:
													</cmr:label>
													<cmr:field path="sectorCd" id="sectorCd" fieldId="Sector"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="CustBillingContactNm"
												forCountry="778,834">
												<p>
													<cmr:label fieldId="contactName1">
														<cmr:fieldLabel fieldId="CustBillingContactNm" />:
													</cmr:label>
													<cmr:field path="contactName1" id="contactName1"
														fieldId="CustBillingContactNm" tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="CollBoId"
												forCountry="749,852,856,778,818">
												<p>
													<cmr:label fieldId="collBoId">
														<cmr:fieldLabel fieldId="CollBoId" />:
													</cmr:label>
													<cmr:field path="collBoId" id="collBoId" fieldId="CollBoId"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
										</cmr:row>
										...
										<cmr:view exceptForCountry="643,749,778,818,834,852,856,646,714,720"
											exceptForGEO="FR">
											<cmr:row topPad="10" addBackground="true">
												<cmr:column span="2" containerForField="Enterprise"
													exceptForGEO="MCO1,NORDX" exceptForCountry="755">
													<p>
														...
														<cmr:field id="enterprise" path="enterprise"
															fieldId="Enterprise" tabId="MAIN_IBM_TAB" />
														<cmr:view forCountry="618">
															<% if (reqentry.getReqType().equalsIgnoreCase("C")) { String
																findCmrJs="onclick=\" importByEnterprise()\""; if
																(readOnly){ findCmrJs="" ; } %>
																<img title="Search for the CMR"
																	class="cmr-proceed2-icon"
																	src="${resourcesPath}/images/search-icon2.png"
																	<%=findCmrJs%>>
																<% } %>
														</cmr:view>
													</p>
												...
												<cmr:column span="2" containerForField="Company"
													exceptForCountry="666,726,862,822,838"
													exceptForGEO="MCO1,MCO2,CEMEA,BELUX,NL">
													<p>
														<cmr:label fieldId="company">
															<cmr:fieldLabel fieldId="Company" />:
															<cmr:delta text="${rdcdata.company}"
																oldValue="${reqentry.company}" />
														</cmr:label>
														<cmr:field fieldId="Company" id="company" path="company"
															tabId="MAIN_IBM_TAB" />
													</p>
												</cmr:column>
												<cmr:column span="2" containerForField="Affiliate"
													exceptForCountry="666,726,862,822,838,641"
													exceptForGEO="MCO1,MCO2,CEMEA,NORDX,BELUX,NL">
													<p>
														<cmr:label fieldId="affiliate">
															<cmr:fieldLabel fieldId="Affiliate" />:
															<cmr:delta text="${rdcdata.affiliate}"
																oldValue="${reqentry.affiliate}" />
														</cmr:label>
														<cmr:field fieldId="Affiliate" id="affiliate" path="affiliate"
															tabId="MAIN_IBM_TAB" />
													</p>
												</cmr:column>
											</cmr:row>
										...
										<cmr:row topPad="10">
											<cmr:column span="2" containerForField="BuyingGroupID">
												<p>
													...
													<cmr:field fieldId="BuyingGroupID" id="bgId" path="bgId"
														tabId="MAIN_IBM_TAB" />
													<form:hidden path="bgDesc" id="bgDesc" />
													<span class="cmr-bluepages-ro" id="bgDescCont">${reqentry.bgDesc !=
														null ? reqentry.bgDesc : "(no description available)"}</span>
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="GlobalBuyingGroupID">
												<p>
													<cmr:label fieldId="globalBuyingGroupId">
														...
														<cmr:delta text="${rdcdata.gbgId}"
															oldValue="${reqentry.gbgId}" />
													</cmr:label>
													<cmr:field fieldId="GlobalBuyingGroupID" id="gbgId" path="gbgId"
														tabId="MAIN_IBM_TAB" />
													<form:hidden path="gbgDesc" id="gbgDesc" />
													<span class="cmr-bluepages-ro" id="gbgDescCont">${reqentry.gbgDesc
														!= null ? reqentry.gbgDesc : "(no description
														available)"}</span>
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="BGLDERule">
												<p>
													<cmr:label fieldId="globalBuyingGroupId">
														...
														<cmr:delta text="${rdcdata.bgRuleId}"
															oldValue="${reqentry.bgRuleId}" />
													</cmr:label>
													<cmr:field fieldId="BGLDERule" id="bgRuleId" path="bgRuleId"
														tabId="MAIN_IBM_TAB" />
												</p>
											</cmr:column>
										</cmr:row>
											...
											<cmr:column span="2" containerForField="CoverageID">
												<p>
													<cmr:label fieldId="covId">
														...
														<cmr:delta text="${rdcdata.covId}"
															oldValue="${reqentry.covId}" />
													</cmr:label>
													<cmr:field fieldId="CoverageID" id="covId" path="covId"
														tabId="MAIN_IBM_TAB" />
													<form:hidden path="covDesc" id="covDesc" />
													<span class="cmr-bluepages-ro" id="covDescCont">${reqentry.covDesc
														!= null ? reqentry.covDesc : "(no description
														available)"}</span>
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="GeoLocationCode">
												<p>
													<cmr:label fieldId="geoLocationCode">
														...
														<cmr:delta text="${rdcdata.geoLocCd}"
															oldValue="${reqentry.geoLocationCd}" />
													</cmr:label>
													<cmr:field fieldId="GeoLocationCode" id="geoLocationCd"
														path="geoLocationCd" tabId="MAIN_IBM_TAB" />
													<form:hidden path="geoLocDesc" id="geoLocDesc" />
													<span class="cmr-bluepages-ro"
														id="geoLocDescCont">${reqentry.geoLocDesc != null ?
														reqentry.geoLocDesc : "(no description available)"}</span>
												</p>
											</cmr:column>
											<cmr:column span="2" containerForField="DUNS">
												<p>
													<cmr:label fieldId="dunsNo">
														...
														<cmr:delta text="${rdcdata.dunsNo}"
															oldValue="${reqentry.dunsNo}" />
													</cmr:label>
													<cmr:field fieldId="DUNS" id="dunsNo" path="dunsNo"
														tabId="MAIN_IBM_TAB" />
													<%if (!readOnly){%>
														<span class="cmr-bluepages-ro" title="Validate DUNS against D&B"
															style="font-family: Geneva, Arial, Helvetica, sans-serif; font-size: 12px;"
															id="geoLocDescCont"><a
																href="javascript: checkDUNSWithDnB()">Check
																D&B</a></span>
														<%}%>
												</p>
											</cmr:column>
										...
										<%if (!newEntry && !readOnly){%>
											<cmr:row topPad="10">
												<cmr:column span="4">
													<cmr:button label="Retrieve Values"
														onClick="retrieveInterfaceValues()" highlight="true">
													</cmr:button>
														...
														<%} else {%>
															...
															<%} %>
																<%if (reqentry.getCmrIssuingCntry().equalsIgnoreCase("796")
																	&& "Requester"
																	.equalsIgnoreCase(reqentry.getUserRole()) &&
																	reqentry.getCustSubGrp()!=null &&
																	(reqentry.getCustSubGrp().equalsIgnoreCase("NRMLC")
																	||
																	reqentry.getCustSubGrp().equalsIgnoreCase("AQSTN"))){%>
																	<span
																		class="ibm-required cmr-required-spacer">*</span>
																	<%}%>
																		<cmr:info text="${ui.info.coverageBg}">
																		</cmr:info>
												</cmr:column>
												<br>
												&nbsp;
														...
														<cmr:column span="2" containerForField="PPSCEID">
															<p>
																<cmr:label fieldId="ppsceid">
																	...
																	<cmr:delta text="${rdcdata.ppsceid}"
																		oldValue="${reqentry.ppsceid}" />
																</cmr:label>
																<cmr:field fieldId="PPSCEID" id="ppsceid" path="ppsceid"
																	tabId="MAIN_IBM_TAB" />
															</p>
														</cmr:column>
														<cmr:column span="2" containerForField="MembLevel">
															<p>
																<cmr:label fieldId="memLvl">
																	...
																	<cmr:delta text="${rdcdata.memLvl}"
																		oldValue="${reqentry.memLvl}" code="L" />
																</cmr:label>
																<cmr:field fieldId="MembLevel" id="memLvl" path="memLvl"
																	tabId="MAIN_IBM_TAB" />
															</p>
														</cmr:column>
														...
														<cmr:row topPad="10">
															<cmr:column span="2" containerForField="SOENumber">
																<p>
																	...
																	<cmr:field fieldId="SOENumber" id="soeReqNo"
																		path="soeReqNo" tabId="MAIN_IBM_TAB" />
																</p>
															</cmr:column>
														</cmr:row>
												</cmr:view>
