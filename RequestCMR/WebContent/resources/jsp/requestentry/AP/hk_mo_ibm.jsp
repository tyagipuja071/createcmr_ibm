...
<cmr:section id="IBM_REQ_TAB" hidden="true">
	...
	<cmr:row addBackground="true">
		<cmr:column span="1" containerForField="CMRNumber">
			<p>
                ...
                <span id="cmrDelta"><cmr:delta
							text="${rdcdata.cmrNo}" oldValue="${reqentry.cmrNo}" /></span>
				</cmr:label>
      ...
      <%--  <cmr:view forCountry="744"> 
		...
		<cmr:column span="2" containerForField="ISU">
			<p>
              ...
              <cmr:delta text="${rdcdata.isuCd}"
						oldValue="${reqentry.isuCd}" code="L" />
				</cmr:label>
	...
	<cmr:row topPad="10">
		<cmr:column span="2" containerForField="MrcCd">
			<p>
				<cmr:label fieldId="mrcCd">
					<cmr:fieldLabel fieldId="MrcCd" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="BPName" forCountry="738,736">
			<p>
				<label for="bpName"> <cmr:fieldLabel fieldId="BPName" />: <cmr:delta
						text="${rdcdata.bpName}" oldValue="${reqentry.bpName}" code="L" />
				</label>
		...
		<cmr:column span="2" containerForField="ProvinceName"
			...
			<p>
				<cmr:label fieldId="busnType">
					<cmr:fieldLabel fieldId="ProvinceName" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="ProvinceCode"
			...
			<p>
				<cmr:label fieldId="territoryCd">
					<cmr:fieldLabel fieldId="ProvinceCode" />: </cmr:label>
				<cmr:field path="territoryCd" id="territoryCd"
					fieldId="ProvinceCode" tabId="MAIN_IBM_TAB" />
			</p>
		</cmr:column>
		<cmr:column span="2" containerForField="CustomerServiceCd"
			forCountry="796">
			<p>
				<cmr:label fieldId="engineeringBo">
					<cmr:fieldLabel fieldId="CustomerServiceCd" />: </cmr:label>
	...
	<cmr:row topPad="10">
			...
			<p>
				<cmr:label fieldId="repTeamMemberNo">
					<cmr:fieldLabel fieldId="SalRepNameNo" />:<cmr:info
						text="No impact on CMR/account owner, just AP CMR legacy system(WTAAS) requirement. "></cmr:info>
					...
					<cmr:view exceptForCountry="736,738">
						<div class="cmr-inline">
							<cmr:bluepages model="salesRepNameNo"
								namePath="repTeamMemberName" idPath="repTeamMemberNo"
								useUID="true" editableId="true" />
		...
		<cmr:column span="2" containerForField="CmrNoPrefix">
			<p>
				<label for="cmrNoPrefix"> <cmr:fieldLabel
						fieldId="CmrNoPrefix" />:
				</label>
			...
			<p>
				<cmr:label fieldId="collectionCd">
           	    ...
           	    <cmr:delta text="${rdcdata.collectionCd}"
						oldValue="${reqentry.collectionCd}" id="delta-engineeringBo" />
				</cmr:label>
		...
		<cmr:view forCountry="643,818,615,852,856,749,778,834,652,744,616,796">
			...
			<cmr:column span="1" width="230" containerForField="INACCode">
            	...
            	<cmr:delta text="${rdcdata.inacCd}"
					...
					<cmr:field size="180" fieldId="INACCode" id="inacCd" path="inacCd"
						tabId="MAIN_IBM_TAB" />
				</p>
			</cmr:column>
		</cmr:view>
		...
		<cmr:column span="2" containerForField="ISBU">
			<p>
				<cmr:label fieldId="isbuCd">
					<cmr:fieldLabel fieldId="ISBU" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="RestrictedInd">
			<p>
				<cmr:label fieldId="restrictInd">
					<cmr:fieldLabel fieldId="RestrictedInd" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="RegionCode">
			<p>
				<cmr:label fieldId="miscBillCd">
					<cmr:fieldLabel fieldId="RegionCode" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="GovIndicator">
			<p>
				<cmr:label fieldId="govType">
					<cmr:fieldLabel fieldId="GovIndicator" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="Sector">
			<p>
				<cmr:label fieldId="sectorCd">
					<cmr:fieldLabel fieldId="Sector" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="CustBillingContactNm"
			...
			<p>
				<cmr:label fieldId="contactName1">
					<cmr:fieldLabel fieldId="CustBillingContactNm" />: </cmr:label>
		...
		<cmr:column span="2" containerForField="CollBoId"
			...
			<p>
				<cmr:label fieldId="collBoId">
					<cmr:fieldLabel fieldId="CollBoId" />: </cmr:label>
		...
		<cmr:row topPad="10" addBackground="true">
			<cmr:column span="2" containerForField="Enterprise"
              ...
              <cmr:delta text="${rdcdata.enterprise}"
			       ...
			       %>
						<img title="Search for the CMR" class="cmr-proceed2-icon"
							src="${resourcesPath}/images/search-icon2.png" <%=findCmrJs%>>
						<%
               }
             %>
					</cmr:view>
	...
	<cmr:row topPad="10">
		<cmr:column span="2" containerForField="BuyingGroupID">
			<p>
             ...
             <cmr:delta text="${rdcdata.bgId}"
						oldValue="${reqentry.bgId}" />
				</cmr:label>
			...
			<p>
             ...
             <cmr:delta text="${rdcdata.dunsNo}"
				...
				<span class="cmr-bluepages-ro" title="Validate DUNS against D&B"
					...
					id="geoLocDescCont"><a href="javascript: checkDUNSWithDnB()">Check
						D&B</a></span>
				<%}%>
			</p>
		</cmr:column>
