...
<cmr:section id="CUST_REQ_TAB" hidden="true">
  ...
  <cmr:row addBackground="true">
    ...
    <cmr:view exceptForCountry="631,848,649" exceptForGEO="LA,JP">
      ...
      <cmr:view  exceptForCountry="897,649,641,618,624,678,702,706,724,754,788,806,846,848,866">
      ...
      <cmr:view forGEO="MCO,CEMEA" exceptForCountry="755,618">
   ...
   <cmr:view forGEO="MCO1,MCO2">
    ...
    <cmr:view forCountry="796">
      ...
      <cmr:view forCountry="618,624,678,702,706,724,754,788,806,846,848,866">
