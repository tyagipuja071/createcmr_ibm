...
<%
   ...
   %>
	...
	Myanmar (Burma),Nicaragua, Oman, Pakistan, Palestine, Qatar, Russia, Saudi Arabia, Taiwan, Tajikistan, 
   ...
   <cmr:chk-section name="Section A:  Denied Parties List Status" >
      <cmr:chk-entry number="1" section="A">
         Is the Customer on the DPL?
          <span id="checklist_txt_field_4" style="display:none"><label for="dijit_form_TextBox_4">If yes, please provide an explanation below detailing this customer's business:</label>
