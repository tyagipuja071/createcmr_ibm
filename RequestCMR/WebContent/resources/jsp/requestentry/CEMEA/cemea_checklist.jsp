...
%>
<cmr:checklist title1="Customer Screening Checklist" title2="Diversion Risk Profile / Proliferation / Military">
  ...
  <cmr:chk-section name="DRP Questionnaire">
    ...
    <cmr:chk-entry>
      ...
      <br>
      <br>
      Military end user/end use is broadly defined to include not only traditional military establishments
      and laboratories, but also quasi-military organizations like Federal Security Service and may
      include seemingly non-military end users /end uses which may be involved in military contracts or
  ...
  <cmr:chk-block boldText="false">
    Screening is required for each new customer in CEMA and for every new transaction in Albania, Armenia, Azerbaijan, Belarus, 
    Bosnia, Georgia, Iraq, Jordan, Kazakhstan, Kirghizia, Lebanon, The former Yugoslav republic of Macedonia, Moldavia, Russia, 
    Serbia and Montenegro, Syria, Turkmenistan, Tajikistan, Ukraine and Uzbekistan.
    <br>
    <br>
    If the customer status changes during the course of a transaction pr whenever IBM becomes aware of a change a new screening must be completed 
    immediately to reflect the changes or the new information.
  </cmr:chk-block>
