...
<cmr:view forGEO="EMEA">
  ...
  <cmr:view exceptForCountry="726,666,862,755,866">
  <script src="${resourcesPath}/js/requestentry/validators/emea_validations.js?${cmrv}" type="text/javascript"></script>
  </cmr:view>
...
<cmr:view forGEO="CEMEA">
  ...
  <cmr:view exceptForCountry="866,620,642,675,677,680,752,762,767,768,772,805,808,823,832,849,850,865,729,618,358,359,363,603,607,626,644,651,668,693,694,695,699,704,705,707,708,713,740,741,787,820,821,826,829">
