                  ...
                  <%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
                    ...
                    <%@ taglib uri="/tags/cmr" prefix="cmr" %>
                      <% RequestEntryModel reqentry=(RequestEntryModel) request.getAttribute("reqentry"); Boolean
                        readOnly=(Boolean) request.getAttribute("yourActionsViewOnly"); if (readOnly==null){
                        readOnly=false; } GEOHandler handler=RequestUtils.getGEOHandler(reqentry.getCmrIssuingCntry());
                        boolean showName=handler !=null && handler.customerNamesOnAddress(); //Defect 1361141: By Mukesh
                        boolean processingStatus="Processed" .equalsIgnoreCase(reqentry.getProcessingStatus()) ? true :
                        false ; String updateInd="U" .equals(reqentry.getReqType()) ? "Y" : "N" ; String
                        AP_ASEAN="643,646,749,818,834,852,856,778,714,720" ; String AP_ISA="744,652,615,790" ; String
                        AP_HK="736,738" ; String AP_ANZ="616,796" ; %>
                        <style>
                          .cmr-middle {
                            text-align: center;
                          }
                        ...
                        <cmr:section id="NAME_REQ_TAB" hidden="true">
                              ...
                              <p>
                                <cmr:label fieldId="dplCheck">
                                  ...
                                  <%if ("Processor".equalsIgnoreCase(reqentry.getUserRole())){%>
                                    ...
                                    <%} %>
                                      <cmr:info
                                        text="The results of the automated DPL check done against Export Validation Services (EVS). Results are returned as pass or fail only per address." />
                                </cmr:label>
                              <div>
                          ...
                          <c:if
                            test="${fn:trim(reqentry.dplChkResult) == 'AF' || fn:trim(reqentry.dplChkResult) == 'SF'}">
                            <cmr:row>
                              <cmr:column span="1" width="220">
                                <p>
                                  <cmr:label fieldId="dplCheck">
                                    ...
                                    <cmr:info
                                      text="The final assessment made by a user when searching directly against the DPL database and comparing the customer information against the list of DPL entities returned." />
                                  </cmr:label>
                                <div>
                              ...
                              <cmr:column span="1" width="250">
                                <p>
                                  <%if (!readOnly) {%>
                                    <input type="button" title="Assess DPL Results"
                                      value="Search and Assess DPL Matches" class="cmr-grid-btn-h btn-search"
                                      onclick="openDPLSearch()">
                                    <cmr:info
                                      text="Opens a new window and searches directly against the DPL Database" />
                                    <%}%>
                                </p>
                              </cmr:column>
                            </cmr:row>
                          ...
                          <% String contextPath=request.getContextPath(); String actions=UIMgr.getText("grid.actions");
                            String infoTxt=UIMgr.getText("info.addrActionInfo"); String actionsHeader=actions+"<img
                            src=\""+contextPath+"/resources/images/info-bubble-icon.png\" title=\""+infoTxt+"\"
                            class=\"cmr-info-bubble\">";
                            %>
                            <cmr:row addBackground="true" topPad="10">
                              <cmr:column span="6">
                                <cmr:grid url="/request/address/list.json" id="ADDRESS_GRID" span="6" height="250"
                                  usePaging="false" hasCheckbox="<%=!readOnly%>" checkBoxKeys="reqId,addrType,addrSeq">
                                  ...
                                  <%if (showName){%>
                                    ...
                                    <cmr:view forGEO="FR">
                                      <%-- <cmr:gridCol width="120px" field="custNm3"
                                        header="Customer Name/ Additional Address Information" /> --%>
                                      <cmr:gridCol width="120px" field="custNm3" header="Division/Department" />
                                      <cmr:gridCol width="120px" field="custNm4"
                                        header="Attention to/Building/Floor/Office" />
                                    </cmr:view>
                                    <%} %>
                                      ...
                                      <cmr:view forGEO="IERP,CND,FR,SWISS">
                                        <cmr:gridCol width="70px" field="ierpSitePrtyId"
                                          header="${ui.grid.ierpSitePrtyId}" />
                                      </cmr:view>
                                      ...
                                      <cmr:view forGEO="AP">
                                        <cmr:gridCol width="130px" field="addrTxt"
                                          header="Address. <br> Address. Cont1">
                                          <cmr:formatter functionName="streetValueFormatter" />
                                        </cmr:gridCol>
                                      </cmr:view>
                                      ...
                                      <cmr:view forCountry="848">
                                        <cmr:gridCol width="100px" field="hwInstlMstrFlg" header="Hardware Master">
                                        </cmr:gridCol>
                                      </cmr:view>
                                      ...
                                      <%if ("U".equals(reqentry.getReqType())){ %>
                                        ...
                                        <%} %>
                                          ...
                                          <cmr:view exceptForGEO="BELUX,JP"
                                            exceptForCountry="838,755,822,726,666,862,758,358,359,363,603,607,626,644,651,668,693,694,695,699,704,705,707,708,740,741,787,820,821,826,889,866,754">
                                            <cmr:gridCol width="90px" field="poBox" header="PO Box" />
                                          </cmr:view>

                                          <!-- Phone -->
                                          <cmr:view
                                            exceptForCountry="758,760,603,607,626,644,651,668,693,694,695,699,704,705,707,708,740,741,787,820,821,826,889,358,359,363,620,642,675,677,680,752,762,767,768,772,805,808,823,832,849,850,865,729">
                                          ...
                                          <cmr:view forGEO="JP">
                                            <cmr:gridCol width="100px" field="estabFuncCd"
                                              header="Estab Function Code" />
                                          </cmr:view>
                                          ...
                                          <cmr:view exceptForGEO="EMEA,LA,MCO,JP">
                                            <cmr:gridCol width="70px" field="addrStdResultText"
                                              header="${ui.grid.addrStdTxt}" />
                                          </cmr:view>

                                          <!-- Create Date -->
                                          <%if (!showName){%>
                                            <cmr:gridCol width="80px" field="createTsString"
                                              header="${ui.grid.createDate}" />
                                            <%} %>
                                </cmr:grid>
                              </cmr:column>
                            </cmr:row>
                            ...
                            <cmr:row topPad="5" addBackground="true">
                              <div class="ibm-col-1-1 cmr-middle">
                                <%if (!readOnly) {%>
                                  <cmr:button id="addAddressButton" label="${ui.btn.addAddress}"
                                    onClick="doAddAddress()" styleClass="cmr-middle" />
                                  <cmr:button id="removeAddressesButton" label="${ui.btn.removeaddresses}"
                                    onClick="removeSelectedAddresses()" styleClass="cmr-middle" pad="true" />
                                  <%if ("C".equals(reqentry.getReqType()) && !"Y".equals(reqentry.getProspLegalInd()))
                                    {%>
                                    <cmr:view forCountry="706">
                                      <cmr:button id="importAddressesButton" label="${ui.btn.importAddress}"
                                        onClick="doAddressImportSearch()" styleClass="cmr-middle" pad="true" />
                                    </cmr:view>
                                    <%}%>
                                      <%} %>
                              </div>
