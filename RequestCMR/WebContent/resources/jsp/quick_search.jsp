...
<!-- 					<div ng-repeat="rec in records | matchGradeFilter "  ng-if="$first" > -->
                      	<input ng-hide="highMatchGrade" type="button" value="Request CMR with Address" title="Request for a new CMR using the information specified under the search criteria." class="search-btn" ng-click="createNewCmr()">
<!--                     </div> -->
