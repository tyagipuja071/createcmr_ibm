            ...
            <cmr:column span="6">
               <table cellspacing="0" cellpadding="0" border="0" summary="System Parameters" class="ibm-data-table ibm-sortable-table ibm-alternating search-results">
                 ...
                 <tbody>
                   ...
                   <tr>
                     <td colspan="7">
                      <input ng-show="isDNBRecType && !highMatchGrade" type="button" value="Request CMR with Address" title="Request for a new CMR using the information specified under the search criteria." class="search-btn" ng-click="createNewCmr()">
