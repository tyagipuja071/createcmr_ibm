                 ...
                 <tbody>
                   ...
                   <tr>
                     <td colspan="7">
                       ...
                       <input ng-show="records && records.length > 0" type="button" value="Request CMR with blank data" title="Request for a new CMR with only CMR Issuing Country specified." class="search-btn" ng-click="confirmCreateNew()">
