...
<!-- Main Contents -->
<cmr:boxContent>
  <form:form method="POST" action="./auto/process" name="frmCMR" id="frmCMR" class="ibm-column-form ibm-styled-form" modelAttribute="reqentry">
    ...
    <cmr:tabs>
      <cmr:tab label="Request Details" id="MAIN_GENERAL_TAB" active="true" sectionId="GENERAL_REQ_TAB" gridIds="COMMENT_LIST_GRID" />
    </cmr:tabs>
    <!-- Fields start here -->
    ...
    <cmr:section id="GENERAL_REQ_TAB">
      <cmr:row>
        ...
        <cmr:column span="2">
          <p>
            ...
            <cmr:field id="cmrNo" path="cmrNo" size="150" fieldId="CMRNumber" tabId="MAIN_GENERAL_TAB"/>
            <br><a id="retrieve" href="javascript: retrieveCMRData()">Retrieve</a>
          </p>
        </cmr:column>
      </cmr:row>
      <cmr:row>
        <cmr:column span="2" containerForField="RequestingLOB">
          <p>
            ...
            <cmr:field fieldId="RequestingLOB" id="requestingLob" path="requestingLob" tabId="MAIN_GENERAL_TAB"  />
          </p>
        </cmr:column>
        <cmr:column span="2" containerForField="RequestReason">
          <p>
            ...
            <cmr:field fieldId="RequestReason" id="reqReason" path="reqReason" tabId="MAIN_GENERAL_TAB" />
          </p>
        </cmr:column>
      </cmr:row>
      ...
      <cmr:row>
        <cmr:column span="2" containerForField="<%=scenarioType%>">
          <p>
            ...
            <cmr:field fieldId="<%=scenarioType%>" id="custGrp" path="custGrp" tabId="MAIN_GENERAL_TAB"  />
          </p>
        </cmr:column>
        <cmr:column span="2" containerForField="<%=scenarioSubtype%>">
          <p>
            ...
            <cmr:field fieldId="<%=scenarioSubtype%>" id="custSubGrp" path="custSubGrp" tabId="MAIN_GENERAL_TAB" />
          </p>
        </cmr:column>
      </cmr:row>
      <%}%>
      ...
      <cmr:row>
        <cmr:column span="2">
          ...
          <cmr:field fieldId="Comments" id="comment" path="comment" tabId="MAIN_GENERAL_TAB" rows="5" cols="58"/>
        </cmr:column>
      </cmr:row>
      <cmr:row>
        <br>
...
<cmr:section alwaysShown="true">
  <cmr:buttonsRow>
    ...
    <div style="float: right">
     <cmr:view>
     <cmr:button label="Submit Request" onClick="Automation.createRequest('frmCMR')" highlight="true" /> 
  </cmr:view>
    </div>
  </cmr:buttonsRow>
</cmr:section>
