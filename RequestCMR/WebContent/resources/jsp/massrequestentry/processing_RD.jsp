...
<script>
  ...
  var cntry= _pagemodel.cmrIssuingCntry;
   if ((cntry == '838' || cntry == '866' || cntry == '754' || cntry == '758' || cntry == '822' || cntry == '666' || cntry == '864') && _pagemodel.reqType=='R') {
...
<form:form method="POST" action="${contextPath}/reactivaterequest/process" name="frmReactivate" class="ibm-column-form ibm-styled-form"
  ...
  <cmr:row addBackground="true" topPad="10">
    ...
    <%
      if (!readOnly) {
    %>
    <cmr:view exceptForCountry="838,866,754,758,822,666,864">
    <cmr:column span="2">
      <cmr:row>
        <cmr:buttonsRow>
    ...
    <cmr:view forCountry="838,866,754,758,822,666,864">
