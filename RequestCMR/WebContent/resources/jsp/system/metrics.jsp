  ...
  dojo.addOnLoad(function() {
    ...
    if (_typeHandler == null) {
      _typeHandler = dojo.connect(FormManager.getField('reportType'), 'onChange', function(value) {
          ...
          if (type == 'S'){
            FormManager.setValue('countType', 'C');
    ...
    FormManager.addValidator('countType', Validators.REQUIRED, [ 'Retrieve Records' ]);
  ...
  <cmr:section>
    <form:form method="GET" action="${contextPath}/metrics/export" id="frmCMR" name="frmCMR" class="ibm-column-form ibm-styled-form"
        ...
        <cmr:column span="2" width="235">
          <p>
            <form:select dojoType="dijit.form.FilteringSelect" id="reportType" searchAttr="name" style="display: block; " maxHeight="200"
              ...
              <form:option value="G">By GEO</form:option>
              <form:option value="C">By Country</form:option>
              <form:option value="T">By Request Type</form:option>
              <form:option value="S">By Current Status</form:option>
            </form:select>
          </p>
        </cmr:column>
        <cmr:column span="2">
      ...
      <cmr:row>
        <cmr:column span="1" width="150">
          <p>
            <cmr:label fieldId="countType">Retrieve Records:</cmr:label>
          </p>
        </cmr:column>
        <cmr:column span="2">
          <p>
            <form:select dojoType="dijit.form.FilteringSelect" id="countType" searchAttr="name" style="display: block; " maxHeight="200"
              required="false" path="countType" placeHolder="Select Retrieve Type">
              <form:option value=""></form:option>
              <form:option value="C">Created during the period</form:option>
              <form:option value="P">Processed during the period</form:option>
            </form:select>
          </p>
        </cmr:column>
      </cmr:row>
      <cmr:row topPad="10">
        <cmr:column span="2">
          <cmr:button label="Generate Report" onClick="CmrMetrics.generateReport()" highlight="true" pad="true" />
    ...
    <div id="filters" style="display: none">
      ...
      <br>
      <a style="font-size:13px" href="javascript: CmrMetrics.selectFilters(true)">Select All</a><br>
