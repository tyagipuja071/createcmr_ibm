...
/**
 * The persistent class for the US_BP_INT_CODES database table.
 * 
 * @author Jeffrey Zamora
 */
@Entity
@Table(name = "US_BP_INT_CODES", schema = "SAPR3")
public class BPCodeInt extends BaseEntity<BPCodeIntPK> implements Serializable {
  ...
  @EmbeddedId
  private BPCodeIntPK id;

  @Override
  public BPCodeIntPK getId() {
    return id;
  }

  @Override
  public void setId(BPCodeIntPK id) {
    this.id = id;
  }

  @Column(name = "BP_ABBREV_NM")
  private String nBpAbbrevNm;

  @Column(name = "BP_FULL_NM")
