...
/**
 * The primary key class for the MASS_CREATE database table.
 * 
 * @author Eduard Bernardo
 */
@Embeddable
public class MassCreatePK extends BaseEntityPk implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MassCreatePK)) {
      return false;
    }
    MassCreatePK o = (MassCreatePK) other;
