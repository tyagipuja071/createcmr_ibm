...
/**
 * The primary key class for the MASS_UPDT_DATA database table.
 * 
 * @author Jeffrey Zamora
 */
@Embeddable
public class MassUpdtDataPK extends BaseEntityPk implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MassUpdtDataPK)) {
      return false;
    }
    MassUpdtDataPK o = (MassUpdtDataPK) other;
