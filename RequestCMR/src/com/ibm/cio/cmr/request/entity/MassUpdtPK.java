...
/**
 * The primary key class for the MASS_UPDT database table.
 * 
 * @author Jeffrey Zamora
 */
@Embeddable
public class MassUpdtPK extends BaseEntityPk implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MassUpdtPK)) {
      return false;
    }
    MassUpdtPK o = (MassUpdtPK) other;
