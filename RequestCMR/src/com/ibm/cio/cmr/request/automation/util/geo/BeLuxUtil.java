...
public class BeLuxUtil extends AutomationUtil {
  ...
  private static final List<String> RELEVANT_ADDRESSES = Arrays.asList(CmrConstants.RDC_SOLD_TO, CmrConstants.RDC_BILL_TO,
      CmrConstants.RDC_INSTALL_AT, CmrConstants.RDC_SHIP_TO, CmrConstants.RDC_SECONDARY_SOLD_TO, CmrConstants.RDC_ADDITIONAL_BILL_TO);
        ...
        for (Addr addr : addresses) {
          if (isRelevantAddressFieldUpdated(changes, addr, nonRelAddrFdsDetails)) {
            ...
            if ((addrType.equalsIgnoreCase(CmrConstants.RDC_INSTALL_AT) && soldToCustNm1.equalsIgnoreCase(installAtCustNm))
                || ((addrType.equalsIgnoreCase(CmrConstants.RDC_SHIP_TO) || addrType.equalsIgnoreCase(CmrConstants.RDC_ADDITIONAL_BILL_TO))
