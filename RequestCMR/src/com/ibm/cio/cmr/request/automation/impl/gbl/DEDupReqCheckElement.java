...
public class DEDupReqCheckElement extends DupReqCheckElement {

  private static final Logger LOG = Logger.getLogger(DEDupReqCheckElement.class);

  public DEDupReqCheckElement(String requestTypes, String actionOnError, boolean overrideData, boolean stopOnError) {
  ...
  public void filterDuplicateRequests(EntityManager entityManager, RequestData requestData, AutomationEngineData engineData,
    ...
    if ("C".equals(admin.getReqType()) && data != null) {
      scenarioType = StringUtils.isBlank(data.getCustGrp()) ? "" : data.getCustGrp();
  ...
  public String getProcessCode() {
    return AutomationElementRegistry.DE_DUP_REQ_CHECK;
  }

  @Override
  public String getProcessDesc() {
    return "Germany Duplicate Request Check";
  }
