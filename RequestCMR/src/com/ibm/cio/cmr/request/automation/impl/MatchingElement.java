...
/**
 * 
 * {@link AutomationElement} that performs matching
 * 
 * @author JeffZAMORA
 * 
 */
public abstract class MatchingElement extends AutomationElement<MatchingOutput> {

  public MatchingElement(String requestTypes, String actionOnError, boolean overrideData, boolean stopOnError) {
