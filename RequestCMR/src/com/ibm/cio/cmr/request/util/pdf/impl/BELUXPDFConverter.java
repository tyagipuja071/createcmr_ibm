 ...
 * 
 */
public class BELUXPDFConverter extends DefaultPDFConverter {
  private static final Logger LOG = Logger.getLogger(DefaultPDFConverter.class);
  private PdfFont regularFont;

  public BELUXPDFConverter(String cmrIssuingCntry) throws IOException {
  ...
  protected void addMainDetails(Admin admin, Data data, Document document) {
    ...
    if (Arrays.asList(balkan).contains(cmrCntry)) {
      ...
      case "624":
        main.addCell(createValueCell("Belgium"));
        break;
      case "624LU":
        main.addCell(createValueCell("Luxembourg"));
        break;
      }
    }
