...
public class UserHelper {
  ...
  boolean isAuthenticated() {
    ...
    /*
     * if there is a subject and the public credentials of that subject contains
     * at least one WSCredential that is not unauthenticated, then return true
     */
    if (_subject != null) {
  ...
  /*
   * Look for a private credential of type java.util.Hashtable, and then within
   * there for an entry with name "access_token". This was reverse-engineered
   * from looking at dump.jsp
   */
  ...
  /*
   * Where the email address is located is going to depend somehwat on how the
   * user authenticated. This method tries to be a little clever about figuring
   * that out.
   */
  ...
  public String getDisplayName() {
    /*
     * Look for an idtoken claim called displayName. If not found, use principal
     * name
     */
    String result = null;
