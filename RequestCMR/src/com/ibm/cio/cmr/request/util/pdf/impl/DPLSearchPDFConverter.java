...
public class DPLSearchPDFConverter extends DefaultPDFConverter {
  ...
  public boolean exportToPdfWithWatsonx(EntityManager entityManager, Admin admin, Data data, OutputStream os, String sysLoc, String watsonxOutput)
      throws IOException {
    try {
      PdfWriter writer = new PdfWriter(os);
      try {
        ...
        try {
          ...
          try {
            ...
            Paragraph paragraph = new Paragraph(watsonxOutput);
