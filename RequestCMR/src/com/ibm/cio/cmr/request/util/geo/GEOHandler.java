...
public abstract class GEOHandler {
	...
	public static final List<String> ADDRESS_FIELDS_SKIP_CHECK = Arrays.asList("REQ_ID", "ADDR_TYPE", "ADDR_SEQ",
			"ADDR_STD_RESULT", "ADDR_STD_ACCEPT_IND", "ADDR_STD_REJ_REASON", "ADDR_STD_REJ_CMT", "ADDR_STD_TS",
			"IMPORT_IND", "DPL_CHK_RESULT", "DPL_CHK_INFO", "DPL_CHK_TS", "DPL_CHK_BY_ID", "DPL_CHK_BY_NM",
			"DPL_CHK_ERR_LIST", "RDC_CREATE_DT", "RDC_LAST_UPDT_DT", "COUNTY_NAME", "STD_CITY_NM", "PAIRED_ADDR_SEQ");
	 ...
	 * @throws Exception
	 */
	public abstract void convertFrom(EntityManager entityManager, FindCMRResultModel source, RequestEntryModel reqEntry,
	 ...
	 * @throws Exception
	 */
	public abstract void setDataValuesOnImport(Admin admin, Data data, FindCMRResultModel results,
			FindCMRRecordModel mainRecord) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract void createOtherAddressesOnDNBImport(EntityManager entityManager, Admin admin, Data data)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract void setAddressValuesOnImport(Addr address, Admin admin, FindCMRRecordModel currentRecord,
			String cmrNo) throws Exception;
	...
	/**
	 * Sets any default values for the Admin record during creation. Called
	 * during CMR import for new records or when a new request is being created
	 * 
	 * @param admin
	 */
	...
	/**
	 * Sets any default values for the Data record during creation. Called
	 * during CMR import for new records or when a new request is being created
	 * 
	 * @param data
	 */
	...
	/**
	 * When loading a request on the details page, this will be called to
	 * retrieve any country specific page attributes.<br>
	 ...
	 * @throws Exception
	 */
	public abstract void appendExtraModelEntries(EntityManager entityManager, ModelAndView mv, RequestEntryModel model)
			throws Exception;
	...
	/**
	 * For retrieval of Coverage information, converts the request to the
	 * correct values based on the {@link Admin} and {@link RequestEntryModel}
	 * values
	 * 
	 * @param entityManager
	 * @param request
	 ...
	 * @param data
	 */
	public abstract void convertCoverageInput(EntityManager entityManager, CoverageInput request, Addr mainAddr,
	...
	/**
	 * Splits the street/address field into two values. Returns a String array
	 * of length 2
	 * 
	 * @param addr
	 * @param addr1
	 ...
	 */
	public abstract void doBeforeAdminSave(EntityManager entityManager, Admin admin, String cmrIssuingCntry)
			throws Exception;
	 ...
	 * @param cmrIssuingCntry
	 */
	public abstract void doBeforeDataSave(EntityManager entityManager, Admin admin, Data data, String cmrIssuingCntry)
			throws Exception;
	 ...
	 * @param cmrIssuingCntry
	 */
	public abstract void doBeforeAddrSave(EntityManager entityManager, Addr addr, String cmrIssuingCntry)
			throws Exception;
	...
	/**
	 * Called after performing all processes of Import CMR. Can be used to
	 * perform last process changes
	 * 
	 * @param entityManager
	 * @param admin
	 * @param data
	...
	/**
	 * Called when displaying the address record for Update requests. Returns
	 * the address update mode indicator.<br>
	 * <ul>
	...
	/**
	 * Returns true if the handler determines that checklists are needed for
	 * this country
	 * 
	 ...
	 * @throws Exception
	 */
	public ImportCMRModel handleImportAddress(EntityManager entityManager, HttpServletRequest request,
			ParamContainer params, ImportCMRModel searchModel) throws Exception {
		...
		if (result != null && result.getItems() != null) {
			...
			if (cmr != null) {
				...
				transaction.begin();
				try {
					LOG.debug("Importing " + cmr.getCmrAddrTypeCode() + " address from CMR " + cmr.getCmrNum()
							+ " Issued By: " + cmr.getCmrIssuedBy());
					Addr addr = new Addr();
	 ...
	 * @return
	 */
	public boolean isAddressChanged(EntityManager entityManager, Addr addr, String cmrIssuingCntry,
			boolean computedChangeInd) {
	...
	public ApprovalReq handleBPMANAGERApproval(EntityManager entityManager, long reqId, ApprovalReq approver,
			DefaultApprovals defaultApprovals, DefaultApprovalRecipients recipients, AppUser user,
			RequestEntryModel model) throws CmrException, SQLException {
		return null;
	}
	...
	/**
	 * Generate the sequence number when a new address is created on the
	 * request.
	 * 
	 * @param entityManager
	 * @param addrType
	...
	/**
	 * Do some altering on the {@link RequestEntryModel} object before saving
	 * the data for v2
	 * 
	 * @param model
	 */
	 ...
	 * @param request
	 */
	public void saveV2Entries(EntityManager entityManager, RequestEntryModel model, HttpServletRequest request,
			Admin admin, Data data, Addr soldTo) throws Exception {
		// noop
	}

	/**
	 * Called before the import CMR function. Recreates the original v2 model
	 * for the country for final overrides
	 * 
	 * @param entityManager
	 * @param model
	 * @param requestData
	...
	/**
	 * Called after the global {@link ImportCMRElement} functionality to cater
	 * for processes to be done after the initial import of CMR data to the
	 * request
	 * 
	 * @param entityManager
	 * @param requestData
	 */
	public void doAfterImportCMRFromAutomation(EntityManager entityManager, BaseV2RequestModel model,
	...
	public void convertCoverageRulesInput(EntityManager entityManager,
			com.ibm.cio.cmr.utils.coverage.objects.CoverageInput rulesCovInput, Addr mainAddr, RequestEntryModel data) {
	...
	/**
	 * Called while copying address, and checks whether the current address is
	 * to be copied to additional address or not
	 * 
	 * @param entityManager
	 * @param addr
	 * @param cmrIssuingCntry
	 ...
	 * @throws Exception
	 */
	public boolean checkCopyToAdditionalAddress(EntityManager entityManager, Addr addr, String cmrIssuingCntry)
			throws Exception {
		// noop. override on converter if needed
		return false;
	}
