...
public class RequestSummaryService extends BaseSimpleService<RequestSummaryModel> {
  ...
  // CROSServiceClient client =
  // CmrServicesFactory.getInstance().createClient(SystemConfiguration.getValue("CMR_SERVICES_URL"),
  // CROSServiceClient.class);
  // CROSQueryResponse response =
  // client.executeAndWrap(CROSServiceClient.QUERY_APP_ID, request,
  // CROSQueryResponse.class);
  //
  // HashMap<String, CROSContact> crosContactsMap = new HashMap<String,
  // CROSContact>();
  // HashMap<String, GeoContactInfo> cmrContactsMap = new HashMap<String,
  // GeoContactInfo>();
